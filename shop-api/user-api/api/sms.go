...
func SendSms(ctx *gin.Context) {
	...
	client, err := dysmsapi.NewClientWithAccessKey("cn-beijing", global.ServerConfig.AliyunInfo.ApiKey, global.ServerConfig.AliyunInfo.ApiSecrect)
	if err != nil {
		panic(err)
	}
	...
	request.QueryParams["TemplateCode"] = global.ServerConfig.AliyunSmsInfo.TemplateCode     //阿里云的短信模板号 自己设置
